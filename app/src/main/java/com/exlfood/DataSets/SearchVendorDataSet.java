...
public class SearchVendorDataSet {
   ...
   @Expose
   public SearchVendorRatingDataSet sVRatingDataSet;
   ...
   public SearchVendorRatingDataSet getsVRatingDataSet() {
      return sVRatingDataSet;
   }

   public void setsVRatingDataSet(SearchVendorRatingDataSet sVRatingDataSet) {
      this.sVRatingDataSet = sVRatingDataSet;
   }
