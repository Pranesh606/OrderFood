...
public class ARCuisinesDB extends SQLiteOpenHelper {

    private final static String name = "CuisinesDataBase";
    private final static int version = 1;
    private final static String TABLE_NAME = "cuisines_table";
    ...
    private static ARCuisinesDB sInstance;

    public static synchronized ARCuisinesDB getInstance(Context context) {
        if (sInstance == null) {
            sInstance = new ARCuisinesDB(context.getApplicationContext());
        }
        return sInstance;
    }

    private ARCuisinesDB(Context context) {
