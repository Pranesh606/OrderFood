...
public class CFCuisinesDBTemp extends SQLiteOpenHelper {

   private final static String name = "CfCuisinesDataBaseTemp";
   private final static int version = 1;
   private final static String TABLE_NAME = "cf_cuisines_table_temp";
   ...
   private static CFCuisinesDBTemp sInstance;

   public static synchronized CFCuisinesDBTemp getInstance(Context context) {
      if (sInstance == null) {
         sInstance = new CFCuisinesDBTemp(context.getApplicationContext());
      }
      return sInstance;
   }

   private CFCuisinesDBTemp(Context context) {
