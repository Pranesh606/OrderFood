...
public class CFFiltersDBTemp extends SQLiteOpenHelper {

   private final static String name = "CfFiltersTempDataBase";
   private final static int version = 1;
   private final static String TABLE_NAME = "cf_filters_temp_table";
   ...
   private static CFFiltersDBTemp sInstance;

   public static synchronized CFFiltersDBTemp getInstance(Context context) {
      if (sInstance == null) {
         sInstance = new CFFiltersDBTemp(context.getApplicationContext());
      }
      return sInstance;
   }

   private CFFiltersDBTemp(Context context) {
