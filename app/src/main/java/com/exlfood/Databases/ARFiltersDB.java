...
public class ARFiltersDB extends SQLiteOpenHelper {

    private final static String name = "FiltersDataBase";
    private final static int version = 1;
    private final static String TABLE_NAME = "filters_table";
    ...
    private static ARFiltersDB sInstance;

    public static synchronized ARFiltersDB getInstance(Context context) {
        if (sInstance == null) {
            sInstance = new ARFiltersDB(context.getApplicationContext());
        }
        return sInstance;
    }

    private ARFiltersDB(Context context) {
    ...
    public void removeItemFromFilterList(FilterDbDataSet filterDbDs) {
        ...
        db.delete(TABLE_NAME, FILTER_TYPE_ID +"="+filterDbDs.getmFilterTypeId(), null);
