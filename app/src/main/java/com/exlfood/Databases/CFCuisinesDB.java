...
public class CFCuisinesDB extends SQLiteOpenHelper {

    private final static String name = "CfCuisinesDataBase";
    private final static int version = 1;
    private final static String TABLE_NAME = "cf_cuisines_table";
    ...
    private static CFCuisinesDB sInstance;

    public static synchronized CFCuisinesDB getInstance(Context context) {
        if (sInstance == null) {
            sInstance = new CFCuisinesDB(context.getApplicationContext());
        }
        return sInstance;
    }

    private CFCuisinesDB(Context context) {
