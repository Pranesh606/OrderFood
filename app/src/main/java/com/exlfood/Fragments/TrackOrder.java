...
import com.exlfood.databinding.FragmentTrackOrderBinding;
...
public class TrackOrder extends Fragment {
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        Log.e("onConfigurationChanged","TrackOrder");
        ...
        binding.TrackOrderLayout.setBackgroundColor(getResources().getColor(R.color.white,getActivity().getTheme()));
        binding.TrackOrderFrameLayout.setBackgroundColor(getResources().getColor(R.color.white,getActivity().getTheme()));
        binding.layOrderConfirmDeliveryTimeParent.setBackgroundColor(getResources().getColor(R.color.white,getActivity().getTheme()));

        binding.tvOcDeliveryTime.setTextColor(getResources().getColor(R.color.ar_filter_title_text_color,getActivity().getTheme()));
        binding.tvOcDeliveryTimeMsg.setTextColor(getResources().getColor(R.color.ar_filter_title_text_color,getActivity().getTheme()));
        ...
        binding.imgOrderConfirmBack.setImageDrawable(iconDrawable);

        Window window = getActivity().getWindow();
        window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
        window.setNavigationBarColor(ContextCompat.getColor(getContext(), R.color.navigation_bar_color));

//        binding.mapViewOrderConfirmTrackOrder.getMapAsync(new OnMapReadyCallback() {
//
//            @Override
//            public void onMapReady(GoogleMap googleMap) {
//                // Load the JSON file that defines the dark theme
//                try {
//                    boolean success = googleMap.setMapStyle(
//                            MapStyleOptions.loadRawResourceStyle(
//                                    getContext(), R.raw.map_style_dark));
//                    if (!success) {
//                        Log.e("TAG", "Error setting map style.");
//                    }
//                } catch (Resources.NotFoundException e) {
//                    Log.e("TAG", "Can't find map style file.", e);
//                }
//            }
//        });
