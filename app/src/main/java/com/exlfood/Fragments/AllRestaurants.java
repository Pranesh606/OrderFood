...
import com.exlfood.DataSets.CuisinesDataSet;
import com.exlfood.DataSets.FilterDataSet;
import com.exlfood.DataSets.FilterDbDataSet;
import com.exlfood.DataSets.FilterListApi;
import com.exlfood.DataSets.FilterListDataSet;
import com.exlfood.DataSets.FilterTypeDataSet;
import com.exlfood.DataSets.VendorBannerDataSet;
...
import com.exlfood.Databases.ARCuisinesDBTemp;
import com.exlfood.Databases.ARFiltersDB;
import com.exlfood.Databases.ARFiltersDBTemp;
import com.exlfood.Databases.AreaGeoCodeDB;
import com.exlfood.Databases.CFCuisinesDB;
import com.exlfood.Databases.CFFiltersDB;
...
import com.exlfood.Interfaces.CuisinesApplyCall;
import com.exlfood.Interfaces.FiltersApplyCall;
...
import com.exlfood.databinding.AllRestaurantsBinding;
import com.exlfood.databinding.CuisinesListBottomSheetBinding;
import com.exlfood.databinding.FilterListBottomSheetBinding;
...
public class AllRestaurants extends Fragment implements View.OnClickListener, CuisinesApplyCall, FiltersApplyCall {
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        mAllRBinding.layAllRestaurantParent.setBackgroundColor(getResources().getColor(R.color.white,activity.getTheme()));
        mAllRBinding.layoutAllRestaurant.setBackgroundColor(getResources().getColor(R.color.white,activity.getTheme()));
        mAllRBinding.layoutLocation.setBackgroundColor(getResources().getColor(R.color.white,activity.getTheme()));
        mAllRBinding.recyclerAllRestaurantParent.setBackgroundColor(getResources().getColor(R.color.white,activity.getTheme()));

        mAllRBinding.deliveryText.setTextColor(getResources().getColor(R.color.ar_filter_title_text_color,activity.getTheme()));
        mAllRBinding.filterText.setTextColor(getResources().getColor(R.color.ar_filter_title_text_color,activity.getTheme()));
        mAllRBinding.cuisinesTex.setTextColor(getResources().getColor(R.color.ar_filter_title_text_color,activity.getTheme()));
        mAllRBinding.searchTextAllRes.setTextColor(getResources().getColor(R.color.ar_filter_title_text_color,activity.getTheme()));
...
//        layout_home_restaurant_body.setBackgroundColor(getResources().getColor(R.color.white,activity.getTheme()));
        ...
        mAllRBinding.backBtn.setImageDrawable(iconDrawable);

        Drawable iconDrawable1 = ContextCompat.getDrawable(getContext(), R.drawable.ic_filters_18);
        iconDrawable1.setColorFilter(ContextCompat.getColor(getContext(), R.color.text_color), PorterDuff.Mode.SRC_IN);
        mAllRBinding.filterText.setCompoundDrawablesWithIntrinsicBounds(iconDrawable1, null,null , null);

        Drawable iconDrawable2 = ContextCompat.getDrawable(getContext(), R.drawable.ic_cooking_bowl_18);
        iconDrawable2.setColorFilter(ContextCompat.getColor(getContext(), R.color.text_color), PorterDuff.Mode.SRC_IN);
        mAllRBinding.cuisinesTex.setCompoundDrawablesWithIntrinsicBounds(iconDrawable1, null,null , null);

        Drawable iconDrawable3 = ContextCompat.getDrawable(getContext(), R.drawable.baseline_search_text_color_18dp);
        iconDrawable3.setColorFilter(ContextCompat.getColor(getContext(), R.color.text_color), PorterDuff.Mode.SRC_IN);
        mAllRBinding.searchTextAllRes.setCompoundDrawablesWithIntrinsicBounds(iconDrawable1, null,null , null);
...
//                                                                        mListHolder.mAllRestaurantsListAdapter.mRestaurantListLoadListener();
        ...
        private class AllRestaurantsListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
            ...
            public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                return new RestaurantViewHolder(LayoutInflater.from(getActivity()).inflate(R.layout.rc_all_restaurants_row_new, parent, false));
            }
            ...
            public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
                ...
                if (OrderTypeDB.getInstance(activity).getUserServiceType().equals("2")) {
                    ...
                    String mDTime = activity.getResources().getString(R.string.within) + " " + mVendorList.get(position).getDelivery_time()
                ...
                if (mFreeDelivery != null && mFreeDelivery.equals("1")){
                    ...
                    restaurantViewHolder.tv_delivery_amount.setText(mVendorList.get(position).getDelivery_charge() + " " + activity.getResources().getString(R.string.delivery_fee));
...
//                            toast_layout(activity.getResources().getString(R.string.added_to_the_wishlist), mAllRBinding.wishlistLayout);
                ...
                if (getActivity() != null) {
                    ...
                    if (mVendorList.get(position).getVendorRatingDataSet() != null) {
                        String mCRating = " " + mVendorList.get(position).getVendorRatingDataSet().getRating() + " ";
                        if (mVendorList.get(position).getVendorRatingDataSet().getRating() != null && !mVendorList.get(position).getVendorRatingDataSet().getRating().isEmpty()) {
                ...
                if (m_OfferData != null && !m_OfferData.isEmpty()) {
                    restaurantViewHolder.tv_offerContent.setVisibility(View.VISIBLE);
                    restaurantViewHolder.tv_offerContent.setText(m_OfferData);
                } else {
                    restaurantViewHolder.tv_offerContent.setVisibility(View.GONE);
            ...
            class RestaurantViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
                ...
                LinearLayout mDeliveryAmtContainer, mPickupContainer,
                        mLayImageOverStatus, rating_linear;
