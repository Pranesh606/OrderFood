...
public class RegisterWithOTP extends Fragment implements View.OnClickListener, CountryCodeSelection,
    ...
    public void onConfigurationChanged(Configuration newConfig){
        ...
        mRWOtpBinding.RegisterLayout.setBackgroundColor(getResources().getColor(R.color.white,getActivity().getTheme()));
        mRWOtpBinding.TopLinearLayout.setBackgroundColor(getResources().getColor(R.color.white,getActivity().getTheme()));
        mRWOtpBinding.tittleFrameLayout.setBackgroundColor(getResources().getColor(R.color.white,getActivity().getTheme()));
        mRWOtpBinding.RegisterContainer.setBackgroundColor(getResources().getColor(R.color.white,getActivity().getTheme()));
        mRWOtpBinding.tittle.setTextColor(getResources().getColor(R.color.ar_filter_title_text_color,getActivity().getTheme()));
        mRWOtpBinding.tvRwoNewPwdMsgWithMobileNumber.setTextColor(getResources().getColor(R.color.ar_filter_title_text_color,getActivity().getTheme()));
        mRWOtpBinding.tvRwoRegisterAgreement.setTextColor(getResources().getColor(R.color.ar_filter_title_text_color,getActivity().getTheme()));
        mRWOtpBinding.layRwoMobileNoParent.setBackgroundColor(getResources().getColor(R.color.white,getActivity().getTheme()));
        mRWOtpBinding.tvRwoCountryCode.setTextColor(getResources().getColor(R.color.ar_filter_title_text_color,getActivity().getTheme()));

        mRWOtpBinding.RegisterContainer.setBackgroundColor(getResources().getColor(R.color.white,getActivity().getTheme()));

        mRWOtpBinding.TextInputFirstName.setHintTextColor(ColorStateList.valueOf(getResources().getColor(R.color.app_login_hintTextColor_color)));
        mRWOtpBinding.TextInputFirstName.setDefaultHintTextColor(ColorStateList.valueOf(getResources().getColor(R.color.app_login_hintTextColor_color)));
        mRWOtpBinding.etRwoFirstName.setTextColor(getResources().getColor(R.color.black));
        mRWOtpBinding.etRwoFirstName.setHintTextColor(getResources().getColor(R.color.black));

        mRWOtpBinding.TextInputLastName.setHintTextColor(ColorStateList.valueOf(getResources().getColor(R.color.app_login_hintTextColor_color)));
        mRWOtpBinding.TextInputLastName.setDefaultHintTextColor(ColorStateList.valueOf(getResources().getColor(R.color.app_login_hintTextColor_color)));
        mRWOtpBinding.etRwoLastName.setTextColor(getResources().getColor(R.color.black));
        mRWOtpBinding.etRwoLastName.setHintTextColor(getResources().getColor(R.color.black));

        mRWOtpBinding.TextInputEmail.setHintTextColor(ColorStateList.valueOf(getResources().getColor(R.color.app_login_hintTextColor_color)));
        mRWOtpBinding.TextInputEmail.setDefaultHintTextColor(ColorStateList.valueOf(getResources().getColor(R.color.app_login_hintTextColor_color)));
        mRWOtpBinding.etRwoEmail.setTextColor(getResources().getColor(R.color.black));
        mRWOtpBinding.etRwoEmail.setHintTextColor(getResources().getColor(R.color.black));

        mRWOtpBinding.TextInputPassword.setHintTextColor(ColorStateList.valueOf(getResources().getColor(R.color.app_login_hintTextColor_color)));
        mRWOtpBinding.TextInputPassword.setDefaultHintTextColor(ColorStateList.valueOf(getResources().getColor(R.color.app_login_hintTextColor_color)));
        mRWOtpBinding.etRwoPwd.setTextColor(getResources().getColor(R.color.black));
        mRWOtpBinding.etRwoPwd.setHintTextColor(getResources().getColor(R.color.black));

        mRWOtpBinding.TextInputConfirmPwd.setHintTextColor(ColorStateList.valueOf(getResources().getColor(R.color.app_login_hintTextColor_color)));
        mRWOtpBinding.TextInputConfirmPwd.setDefaultHintTextColor(ColorStateList.valueOf(getResources().getColor(R.color.app_login_hintTextColor_color)));
        mRWOtpBinding.etRwoConfirmPwd.setTextColor(getResources().getColor(R.color.black));
        mRWOtpBinding.etRwoConfirmPwd.setHintTextColor(getResources().getColor(R.color.black));

        mRWOtpBinding.mobileGetOtpTextInputLayout.setHintTextColor(ColorStateList.valueOf(getResources().getColor(R.color.app_login_hintTextColor_color)));
        mRWOtpBinding.mobileGetOtpTextInputLayout.setDefaultHintTextColor(ColorStateList.valueOf(getResources().getColor(R.color.app_login_hintTextColor_color)));
        mRWOtpBinding.etRwoMobile.setTextColor(getResources().getColor(R.color.black));
        mRWOtpBinding.etRwoMobile.setHintTextColor(getResources().getColor(R.color.black));
        ...
        mRWOtpBinding.imgRwoBack.setImageDrawable(iconDrawable);

        Drawable iconDrawable1 = ContextCompat.getDrawable(getContext(), R.drawable.svg_keyboard_arrow_down_custom_color_24dp);
        iconDrawable1.setColorFilter(ContextCompat.getColor(getContext(), R.color.ar_filter_title_text_color), PorterDuff.Mode.SRC_IN);
        mRWOtpBinding.imgRwoCountryCodeArrow.setImageDrawable(iconDrawable1);

        ColorStateList toggleColor = ColorStateList.valueOf(getResources().getColor(R.color.grey_600));
        mRWOtpBinding.TextInputPassword.setPasswordVisibilityToggleTintList(toggleColor);

        ColorStateList toggleColor1 = ColorStateList.valueOf(getResources().getColor(R.color.grey_600));
        mRWOtpBinding.TextInputConfirmPwd.setPasswordVisibilityToggleTintList(toggleColor1);
