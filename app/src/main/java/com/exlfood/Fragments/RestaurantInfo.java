...
import com.exlfood.CustomClasses.SnappingLinearLayoutManager;
import com.exlfood.DataSets.AreaGeoCodeDataSet;
import com.exlfood.DataSets.Category;
import com.exlfood.DataSets.MenuAndItemsDataSet;
import com.exlfood.DataSets.MenuCategorySelectionDataSet;
...
import com.exlfood.databinding.FragmentCategoriesListBottomBinding;
...
public class RestaurantInfo extends Fragment {
    ...
    ImageView img_restaurant_menu_restaurant_logo, menu_item, back_btn, search_btn, wishlist_btn,img_restaurant_menu_item_not_found_image;
    ...
    RecyclerView recycler_restaurant_menu_list;
    ...
    private LinearLayout mLayVendorClosed, order_type_linear, view_all, wishlist_layout,Linear_Layout_Recyclerview,layout_restaurant_menu_restaurant_details;
    private TextView mLayVendorStatus, vendor_reviews_btn, mRatingCount,tv_restaurant_menu_item_not_found_message;
    ...
    CoordinatorLayout lay_restaurant_menu;

    FrameLayout store_menu_frameLayout;
...
//        mNestedScrollView = mView.findViewById(R.id.nested_view_rml);
        ...
        mRating_txt.setVisibility(View.GONE);
        ...
        lay_restaurant_menu = mView.findViewById(R.id.lay_restaurant_menu);
        Linear_Layout_Recyclerview = mView.findViewById(R.id.Linear_Layout_Recyclerview);
        store_menu_frameLayout = mView.findViewById(R.id.store_menu_frameLayout);
        layout_restaurant_menu_restaurant_details = mView.findViewById(R.id.layout_restaurant_menu_restaurant_details);

        img_restaurant_menu_item_not_found_image= mView.findViewById(R.id.img_restaurant_menu_item_not_found_image);
        tv_restaurant_menu_item_not_found_message = mView.findViewById(R.id.tv_restaurant_menu_item_not_found_message);
        ...
        delivery_tv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (currentNightMode == Configuration.UI_MODE_NIGHT_YES) {
                    // The device is currently using a dark theme
//                    TextView deliveryText = mView.findViewById(R.id.delivery_text);
//                    TextView pickupText = mView.findViewById(R.id.pickup_text);
//                    deliveryText.setTextColor(Color.WHITE);
//                    pickupText.setTextColor(Color.BLACK);
//
//                    delivery_info.setTextColor(Color.WHITE);
//                    pickup_info.setTextColor(Color.BLACK);
...
//
//                    delivery_info.setTextColor(Color.BLACK);
//                    pickup_info.setTextColor(Color.WHITE);
                }
                if (!OrderTypeDB.getInstance(activity).getUserServiceType().isEmpty()) {
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        lay_restaurant_menu.setBackgroundColor(getResources().getColor(R.color.white,activity.getTheme()));
        Linear_Layout_Recyclerview.setBackgroundColor(getResources().getColor(R.color.white,activity.getTheme()));
        store_menu_frameLayout.setBackgroundColor(getResources().getColor(R.color.white,activity.getTheme()));
        tv_restaurant_menu_restaurant_title.setTextColor(getResources().getColor(R.color.ar_filter_title_text_color,activity.getTheme()));
        tv_restaurant_menu_item_not_found_message.setTextColor(getResources().getColor(R.color.ar_filter_title_text_color,activity.getTheme()));
        layout_restaurant_menu_restaurant_details.setBackgroundColor(getResources().getColor(R.color.white,activity.getTheme()));
//
////        layout_home_restaurant_body.setBackgroundColor(getResources().getColor(R.color.white,activity.getTheme()));
        Drawable iconDrawable = ContextCompat.getDrawable(getContext(), R.drawable.baseline_menu_black_18dp);
        iconDrawable.setColorFilter(ContextCompat.getColor(getContext(), R.color.black), PorterDuff.Mode.SRC_IN);
        menu_item.setImageDrawable(iconDrawable);

        Drawable iconEmpty = ContextCompat.getDrawable(getContext(), R.drawable.ic_error_outline_black_48dp);
        iconEmpty.setColorFilter(ContextCompat.getColor(getContext(), R.color.colorPrimary), PorterDuff.Mode.SRC_IN);
        img_restaurant_menu_item_not_found_image.setImageDrawable(iconEmpty);

        Drawable myDrawable = ContextCompat.getDrawable(getContext(), R.drawable.bg_text);
        GradientDrawable gradientDrawable = (GradientDrawable) myDrawable;
        gradientDrawable.setColor(ContextCompat.getColor(getContext(), R.color.white));
        gradientDrawable.setStroke((int) getResources().getDimension(com.intuit.sdp.R.dimen._1sdp), ContextCompat.getColor(getContext(), R.color.black));
        vendor_info_txt.setBackground(gradientDrawable);
        vendor_info_txt.setTextColor(getResources().getColor(R.color.ar_filter_title_text_color,activity.getTheme()));

        Drawable myDrawable1 = ContextCompat.getDrawable(getContext(), R.drawable.bg_text);
        ...
        gradientDrawable1.setStroke((int) getResources().getDimension(com.intuit.sdp.R.dimen._1sdp), ContextCompat.getColor(getContext(), R.color.black));
        vendor_reviews_btn.setBackground(gradientDrawable1);
        vendor_reviews_btn.setTextColor(getResources().getColor(R.color.colorPrimary,activity.getTheme()));
    ...
    private void noRatingUI() {
        ...
        mRatingCount.setVisibility(View.GONE);
        vendor_reviews_btn.setVisibility(View.GONE);
        mVendorRatingBar.setVisibility(View.INVISIBLE);
    }
...
*/
    ...
    private void restaurantMenuListDetails(ArrayList<Category> restaurantDetailsList){
        ...
        recycler_restaurant_menu_list.setLayoutManager(snappingLinearLayMgr);
...
//                    if (mAdapterMenuAndChildItemsList.get(position).getItem_type() != null) {
//                        if (mAdapterMenuAndChildItemsList.get(position).getItem_type().equals("1")) {
//                            menuViewHolder.item_type.setImageDrawable(getResources().getDrawable(R.drawable.veg_icon));
//                        } else if (mAdapterMenuAndChildItemsList.get(position).getItem_type().equals("2")) {
//                            menuViewHolder.item_type.setImageDrawable(getResources().getDrawable(R.drawable.non_veg_icon));
//                        } else {
//                            menuViewHolder.item_type.setVisibility(View.GONE);
//                        }
//                    } else {
//                        menuViewHolder.item_type.setVisibility(View.GONE);
//                    }
...
//                    }
                ...
                menuViewHolder.mChildMenuItemsContainer.setOnTouchListener(new View.OnTouchListener() {
                    ...
                    public boolean onTouch(View view, MotionEvent motionEvent) {
                        ...
                        String mSection__Id = mAdapterMenuAndChildItemsList.get(position).getParentSectionId();
