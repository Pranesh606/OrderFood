...
import com.exlfood.DataSets.StoresDataSet;
...
import com.exlfood.databinding.GroceryAllStoresBinding;
...
public class GroceryAllStores extends Fragment implements View.OnClickListener {
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        mGroceryASBinding.groceryLayout.setBackgroundColor(getResources().getColor(R.color.white,activity.getTheme()));
        mGroceryASBinding.recyclerGasParent.setBackgroundColor(getResources().getColor(R.color.white,activity.getTheme()));
        mGroceryASBinding.layoutGroceryMain.setBackgroundColor(getResources().getColor(R.color.white,activity.getTheme()));
        mGroceryASBinding.deliveryText.setTextColor(getResources().getColor(R.color.ar_filter_title_text_color,activity.getTheme()));
...
//        layout_home_restaurant_body.setBackgroundColor(getResources().getColor(R.color.white,activity.getTheme()));
        ...
        mGroceryASBinding.imgGasBackBtn.setImageDrawable(iconDrawable);
...
//
        ...
        public int getItemViewType(int position) {
            ...
            // for search ui - 0 - true
            // for stores list ui - 1 - String
...
*/
        ...
        private class GroceryStoresListAdapter1 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

            private ArrayList<StoresDataSet> mStoreList;
            // RecyclerView recyclerViewVendorList;

            GroceryStoresListAdapter1(ArrayList<StoresDataSet> storeList/*, RecyclerView recyclerViewVendorList*/) {
            ...
            public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                return new RestaurantViewHolder(LayoutInflater.from(getActivity()).inflate(R.layout.grocery_stores_row, parent, false));
            }
...
//                            toast_layout(activity.getResources().getString(R.string.added_to_the_wishlist), mGroceryASBinding.wishlistLayout);
                ...
                if (getActivity() != null) {
                    if (mVendorStatus.equals("0")) {
                        ...
                        // restaurantViewHolder.tv_restaurant_working_status.setText(getActivity().getResources().getString(R.string.closed));
                        ...
                        //  restaurantViewHolder.tv_restaurant_working_status.setText(getActivity().getResources().getString(R.string.busy));
                    } else {
                        //Open :-
                        //   restaurantViewHolder.mRestaurantStatusContainer.setVisibility(View.GONE);
                        //   restaurantViewHolder.mDeliveryAmtContainer.setVisibility(View.VISIBLE);
                ...
                // restaurantViewHolder.tv_delivery_amount.setText(mStoreList.get(position).getDelivery_charge());
...
//                    restaurantViewHolder.iv_Dot.setVisibility(View.VISIBLE);
                    ...
                    restaurantViewHolder.mLayVLOfferContainer.setVisibility(View.INVISIBLE);
//                    restaurantViewHolder.iv_Dot.setVisibility(View.GONE);
            ...
            class RestaurantViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
                ...
                LinearLayout /*mDeliveryAmtContainer,*/ /*mRestaurantStatusContainer,*/ mDeliveryTimeContainer,
                        mLayImageOverStatus, mLayVLOfferContainer/*, rating_linear*/;

                RestaurantViewHolder(View itemView) {
                    super(itemView);
                    itemView.setOnClickListener(this);
                    iv_vendorImage = itemView.findViewById(R.id.iv_gs_restaurant_image);
                    tv_RestaurantTitle = itemView.findViewById(R.id.tv_gs_restaurant_title);
                    tv_restaurant_sub_content = itemView.findViewById(R.id.tv_gs_restaurant_sub_title);
                    //  tv_rating_statement = itemView.findViewById(R.id.tv_gs_rating_msg);
                    //  rating_linear = itemView.findViewById(R.id.rating_linear);
                    // mDeliveryAmtContainer = itemView.findViewById(R.id.lay_gs_restaurant_delivery_amt_container);
                    // tv_delivery_amount_title = itemView.findViewById(R.id.tv_gs_delivery_amt_title);
                    // tv_delivery_amount = itemView.findViewById(R.id.tv_gs_delivery_amt_data);
                    // mRestaurantStatusContainer = itemView.findViewById(R.id.lay_gs_restaurant_status_container);
                    // tv_restaurant_working_status = itemView.findViewById(R.id.tv_gs_restaurant_status);
                    mDeliveryTimeContainer = itemView.findViewById(R.id.lay_gs_restaurant_delivery_time_container);
                    tv_DeliveryTime = itemView.findViewById(R.id.tv_gs_delivery_time);
                    tv_offerContent = itemView.findViewById(R.id.tv_gs_restaurant_offers);
                    mLayImageOverStatus = itemView.findViewById(R.id.lay_gs_restaurant_image);
                    tv_ImageOverStatus = itemView.findViewById(R.id.tv_gs_restaurant_image_over_status);
                    mLayVLOfferContainer = itemView.findViewById(R.id.lay_gs_restaurant_offers);
                    // iv_Dot = itemView.findViewById(R.id.img_gs_restaurant_offers_dot);
...
//                    restaurantViewHolder.iv_Dot.setVisibility(View.GONE);
            ...
            class RestaurantViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
                ...
                TextView tv_rating_statement, tv_delivery_amount_title, tv_delivery_amount, tv_offerContent, tv_ImageOverStatus;
