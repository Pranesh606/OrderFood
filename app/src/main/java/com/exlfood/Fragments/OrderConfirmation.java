...
import com.exlfood.CustomClasses.DirectionsJSONParser;
import com.exlfood.CustomClasses.NetworkAnalyser;
import com.exlfood.DataSets.OrderTrackProductDataSet;
import com.exlfood.DataSets.OrderTrackProductOptionDataSet;
...
import com.exlfood.databinding.OrderConfirmationBinding;
...
//                mCheckOutAddsLongitude = getArguments().getString(DefaultNames.checkOutAddsLongitude);
        ...
        mOConfirmBinding.tvDeliveryBoyInfoTitle.setText(mFinal_rider);
        mOConfirmBinding.tvDeliveryBoyInfoDriverStatus.setText(getActivity().getString(R.string.oc_finding_available_rider));
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        mOConfirmBinding.LinearLayoutTop.setBackgroundColor(getResources().getColor(R.color.white,activity.getTheme()));
        mOConfirmBinding.FrameLayoutTop.setBackgroundColor(getResources().getColor(R.color.white,activity.getTheme()));
        mOConfirmBinding.LinearLayoutTop.setBackgroundColor(getResources().getColor(R.color.white,activity.getTheme()));
        mOConfirmBinding.LinearLayoutMainContainer.setBackgroundColor(getResources().getColor(R.color.white,activity.getTheme()));
//        mOConfirmBinding.layOrderConfirmPreparingTimeParent.setBackgroundColor(getResources().getColor(R.color.white,activity.getTheme()));
//        mOConfirmBinding.layOcDeliveryBoyInfoParent.setBackgroundColor(getResources().getColor(R.color.white,activity.getTheme()));

        mOConfirmBinding.tvOrderConfirmPageTitle.setTextColor(getResources().getColor(R.color.ar_filter_title_text_color,activity.getTheme()));
        mOConfirmBinding.tvOrderConfirmPreparingTime.setTextColor(getResources().getColor(R.color.ar_filter_title_text_color,activity.getTheme()));
        mOConfirmBinding.tvOrderConfirmPreparingTimeMsg.setTextColor(getResources().getColor(R.color.ar_filter_title_text_color,activity.getTheme()));
        mOConfirmBinding.tvDeliveryBoyInfoTitle.setTextColor(getResources().getColor(R.color.ar_filter_title_text_color,activity.getTheme()));
        mOConfirmBinding.tvDeliveryBoyInfoDriverStatus.setTextColor(getResources().getColor(R.color.ar_filter_title_text_color,activity.getTheme()));
        mOConfirmBinding.tvOcDeliveryAddsName.setTextColor(getResources().getColor(R.color.ar_filter_title_text_color,activity.getTheme()));
        mOConfirmBinding.tvOcDeliveryAddsMain.setTextColor(getResources().getColor(R.color.ar_filter_title_text_color,activity.getTheme()));
        mOConfirmBinding.tvOcDeliveryAddsSubMobile.setTextColor(getResources().getColor(R.color.ar_filter_title_text_color,activity.getTheme()));
        mOConfirmBinding.tvOcDeliveryAddsSub.setTextColor(getResources().getColor(R.color.ar_filter_title_text_color,activity.getTheme()));
        mOConfirmBinding.tvOcOrderVendorName.setTextColor(getResources().getColor(R.color.ar_filter_title_text_color,activity.getTheme()));
        mOConfirmBinding.tvOcOrderId.setTextColor(getResources().getColor(R.color.ar_filter_title_text_color,activity.getTheme()));
        mOConfirmBinding.tvOcOrderIdTitle.setTextColor(getResources().getColor(R.color.ar_filter_title_text_color,activity.getTheme()));
        mOConfirmBinding.tvOcOrderAmt.setTextColor(getResources().getColor(R.color.ar_filter_title_text_color,activity.getTheme()));
        mOConfirmBinding.tvOcOrderAmtTitle.setTextColor(getResources().getColor(R.color.ar_filter_title_text_color,activity.getTheme()));
        mOConfirmBinding.tvOcOrderPayment.setTextColor(getResources().getColor(R.color.ar_filter_title_text_color,activity.getTheme()));
        mOConfirmBinding.tvOcOrderPaymentTitle.setTextColor(getResources().getColor(R.color.ar_filter_title_text_color,activity.getTheme()));
        ...
        mOConfirmBinding.imgOrderConfirmBack.setImageDrawable(iconDrawable);

        Drawable iconDrawableimg = ContextCompat.getDrawable(getContext(), R.drawable.svg_work_outline);
        iconDrawable.setColorFilter(ContextCompat.getColor(getContext(), R.color.black), PorterDuff.Mode.SRC_IN);
        mOConfirmBinding.imgWorkOutline.setImageDrawable(iconDrawableimg);

        Drawable iconDrawableimg1 = ContextCompat.getDrawable(getContext(), R.drawable.svg_storefront);
        iconDrawable.setColorFilter(ContextCompat.getColor(getContext(), R.color.black), PorterDuff.Mode.SRC_IN);
        mOConfirmBinding.StoreFront.setImageDrawable(iconDrawableimg1);

        Drawable iconDrawable1 = ContextCompat.getDrawable(getContext(), R.drawable.bg_co_ui_split_box);
        iconDrawable.setColorFilter(ContextCompat.getColor(getContext(), R.color.black), PorterDuff.Mode.SRC_IN);
        mOConfirmBinding.layOrderConfirmPreparingTimeParent.setBackground(iconDrawable1);

        Drawable iconDrawable2 = ContextCompat.getDrawable(getContext(), R.drawable.bg_co_ui_split_box);
        iconDrawable.setColorFilter(ContextCompat.getColor(getContext(), R.color.black), PorterDuff.Mode.SRC_IN);
        mOConfirmBinding.layOcDeliveryBoyInfoParent.setBackground(iconDrawable2);

        Drawable iconDrawable3 = ContextCompat.getDrawable(getContext(), R.drawable.bg_co_ui_split_box);
        iconDrawable.setColorFilter(ContextCompat.getColor(getContext(), R.color.black), PorterDuff.Mode.SRC_IN);
        mOConfirmBinding.layOrderConfirmAddressParent.setBackground(iconDrawable3);


        Drawable iconDrawable4 = ContextCompat.getDrawable(getContext(), R.drawable.bg_co_ui_split_box);
        iconDrawable.setColorFilter(ContextCompat.getColor(getContext(), R.color.black), PorterDuff.Mode.SRC_IN);
        mOConfirmBinding.layOrderConfirmOrderDetailsParent.setBackground(iconDrawable4);
...
//                }
//            }
        } else if (mId == R.id.lay_oc_delivery_boy_info_parent) {
                                    ...
                                    if (mTrackOrderApi != null) {
                                        ...
                                        if (mTrackOrderApi.success != null) {
                                            ...
                                            if (mTrackOrderApi.orderTrack.schedule_status.equals("1")) {
                                                ...
                                                mOConfirmBinding.tvOrderConfirmPreparingTime.setText(mWithin + " " + mTrackOrderApi.orderTrack.delivery_time + " " + mMins);
                                            }
...
//                                            mOConfirmBinding.tvOrderConfirmPreparingTimeMsg.setText(MsgPrefix + " " + mVendorName);
                                            ...
                                            if (!mTrackOrderApi.orderTrack.driver_id.equals("")) {
                                                ...
                                                mOConfirmBinding.tvDeliveryBoyInfoTitle.setText(mTrackOrderApi.orderTrack.driver_name);
                                                mOConfirmBinding.tvDeliveryBoyInfoDriverStatus.setText(getActivity().getString(R.string.track_the_rider));

                                                mOConfirmBinding.layOcDeliveryBoyInfoParent.setOnClickListener(OrderConfirmation.this);
                                            ...
                                            if (mTrackOrderApi.orderTrack.order_status_id.equals("5") || mTrackOrderApi.orderTrack.order_status_id.equals("6")
                                                ...
                                                mOConfirmBinding.layOcDeliveryBoyInfoParent.setEnabled(false);
...
//                                    getActivity().getWindowManager().getDefaultDisplay().getSize(displaySize);
    ...
    private String getDirectionsUrl(LatLng origin, LatLng dest) {
        ...
        String key = "key=" + getResources().getString(R.string.google_server_api_key_1) + getResources().getString(R.string.google_server_api_key_2); // Api Key
