...
import com.exlfood.DataSets.GroceryProductDataSet;
import com.exlfood.DataSets.GroceryStoresSearchApi;
import com.exlfood.DataSets.StoresDataSet;
import com.exlfood.DataSets.VendorDataDataSet;
...
import com.exlfood.Interfaces.ProductListLoadListener;
import com.exlfood.Interfaces.RestaurantListLoadListener;
import com.exlfood.R;
import com.exlfood.databinding.GroceryAllStoresSearchBinding;
...
//
        ...
        private class GroceryStoresListAdapter1 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
            ...
            public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                return new RestaurantViewHolder(LayoutInflater.from(getActivity()).inflate(R.layout.grocery_g_ass_stores_row, parent, false));
            }
...
//                    restaurantViewHolder.iv_Dot.setVisibility(View.GONE);
        ...
        private class GroceryStoresListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
            ...
            @Override
            public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                return new GroceryStoresListAdapter.RestaurantViewHolder(LayoutInflater.from(getActivity()).inflate(R.layout.rc_all_store_row, parent, false));
            }

            @SuppressLint("UseCompatLoadingForDrawables")
            @Override
            public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
                GroceryStoresListAdapter.RestaurantViewHolder restaurantViewHolder = (GroceryStoresListAdapter.RestaurantViewHolder) holder;
                restaurantViewHolder.tv_RestaurantTitle.setText(mStoreList.get(position).name);
                AppFunctions.imageLoaderUsingGlide(mStoreList.get(position).logo, restaurantViewHolder.iv_vendorImage, getActivity());
                //Glide.with(getActivity()).load(R.drawable.x_best_offer_sample_1).into(restaurantViewHolder.iv_BestOfferImage);
                restaurantViewHolder.tv_restaurant_sub_content.setText(mStoreList.get(position).store_types);
