...
import com.exlfood.databinding.GroceryAllFeaturedProductsBinding;
...
public class GroceryAllFeaturedProducts extends Fragment implements View.OnClickListener {
    ...
    public void onConfigurationChanged(Configuration newConfig){
        ...
        mGroceryAFPBinding.groceryAllFeaturedProductLayout.setBackgroundColor(getResources().getColor(R.color.white,getActivity().getTheme()));
        mGroceryAFPBinding.LinearLayoutSearch.setBackgroundColor(getResources().getColor(R.color.white,getActivity().getTheme()));
        mGroceryAFPBinding.layoutSearchIcon.setBackgroundColor(getResources().getColor(R.color.white,getActivity().getTheme()));
        mGroceryAFPBinding.layoutSearchEtdText.setBackgroundColor(getResources().getColor(R.color.white,getActivity().getTheme()));
        mGroceryAFPBinding.layGAfpProductSearchClear.setBackgroundColor(getResources().getColor(R.color.white,getActivity().getTheme()));
        mGroceryAFPBinding.tvGAfpListEmpty.setTextColor(getResources().getColor(R.color.ar_filter_title_text_color,getActivity().getTheme()));

        Drawable iconDrawable = ContextCompat.getDrawable(getContext(), R.drawable.bg_ar_cuisines_search);
        iconDrawable.setColorFilter(ContextCompat.getColor(getContext(), R.color.white), PorterDuff.Mode.SRC_IN);
        mGroceryAFPBinding.searchLayoutTop.setBackgroundDrawable (iconDrawable);
        ...
        mGroceryAFPBinding.imgGAfpBack.setImageDrawable(backIconDrawable);
        ...
        mGroceryAFPBinding.cancelIcon.setImageDrawable(CancelIconDrawable);
