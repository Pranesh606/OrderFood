...
import com.exlfood.databinding.FragmentSearchProductBinding;
...
public class SearchProduct extends Fragment {
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        binding.searchProductLayout.setBackgroundColor(getResources().getColor(R.color.white,getActivity().getTheme()));
        binding.searchText.setTextColor(getResources().getColor(R.color.ar_filter_title_text_color,getActivity().getTheme()));
        ...
        Drawable iconDrawable1 = ContextCompat.getDrawable(getContext(), R.drawable.bg_white_square_with_border);
        iconDrawable1.setColorFilter(ContextCompat.getColor(getContext(), R.color.ar_filter_title_text_color), PorterDuff.Mode.SRC_IN);
        binding.searchTopLayout.setBackgroundDrawable (iconDrawable1);
