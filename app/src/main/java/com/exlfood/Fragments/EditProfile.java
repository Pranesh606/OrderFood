...
import com.exlfood.DataSets.LoginCustomerInfoDataSet;
...
import com.exlfood.databinding.EditProfileBinding;
...
//        }
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        mEPBinding.editAccountLayout.setBackgroundColor(getResources().getColor(R.color.white,getActivity().getTheme()));
        mEPBinding.editAccountTopLinearlayout.setBackgroundColor(getResources().getColor(R.color.white,getActivity().getTheme()));
        mEPBinding.topFrameLayoutEditAccount.setBackgroundColor(getResources().getColor(R.color.white,getActivity().getTheme()));
        mEPBinding.layEpParent.setBackgroundColor(getResources().getColor(R.color.white,getActivity().getTheme()));
        ...
        mEPBinding.imgEpBack.setImageDrawable(iconDrawable);

        mEPBinding.tiEpFirstNameTextInputLayout.setHintTextColor(ColorStateList.valueOf(getResources().getColor(R.color.app_login_hintTextColor_color)));
        mEPBinding.tiEpFirstNameTextInputLayout.setDefaultHintTextColor(ColorStateList.valueOf(getResources().getColor(R.color.app_login_hintTextColor_color)));
        mEPBinding.etEpFirstNameEditText.setTextColor(getResources().getColor(R.color.black));
        mEPBinding.etEpFirstNameEditText.setHintTextColor(getResources().getColor(R.color.black));

        mEPBinding.tiEpLastNameTextInputLayout.setHintTextColor(ColorStateList.valueOf(getResources().getColor(R.color.app_login_hintTextColor_color)));
        mEPBinding.tiEpLastNameTextInputLayout.setDefaultHintTextColor(ColorStateList.valueOf(getResources().getColor(R.color.app_login_hintTextColor_color)));
        mEPBinding.etEpLastNameEditText.setTextColor(getResources().getColor(R.color.black));
        mEPBinding.etEpLastNameEditText.setHintTextColor(getResources().getColor(R.color.black));

        mEPBinding.tiEpTextInputLayout.setHintTextColor(ColorStateList.valueOf(getResources().getColor(R.color.app_login_hintTextColor_color)));
        mEPBinding.tiEpTextInputLayout.setDefaultHintTextColor(ColorStateList.valueOf(getResources().getColor(R.color.app_login_hintTextColor_color)));
        mEPBinding.etEpEmailEditText.setTextColor(getResources().getColor(R.color.black));
        mEPBinding.etEpEmailEditText.setHintTextColor(getResources().getColor(R.color.black));

        mEPBinding.tiEpTelephoneTextInputLayout.setHintTextColor(ColorStateList.valueOf(getResources().getColor(R.color.app_login_hintTextColor_color)));
        mEPBinding.tiEpTelephoneTextInputLayout.setDefaultHintTextColor(ColorStateList.valueOf(getResources().getColor(R.color.app_login_hintTextColor_color)));
        mEPBinding.etEpTelephoneEditText.setTextColor(getResources().getColor(R.color.black));
        mEPBinding.etEpTelephoneEditText.setHintTextColor(getResources().getColor(R.color.black));
