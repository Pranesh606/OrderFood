...
import com.exlfood.DataSets.GroceryCategoryDataSet;
import com.exlfood.DataSets.GroceryProducts;
import com.exlfood.DataSets.GroceryProductsList;
import com.exlfood.DataSets.SubCategoryDataSet;
import com.exlfood.DataSets.SubCategoryList;
...
import com.exlfood.Interfaces.OnLoadMoreListener;
import com.exlfood.R;
import com.exlfood.databinding.FragmentGroceryProductListingBinding;
import com.exlfood.databinding.GroceryCmpBottomBinding;
...
public class GroceryProductListing extends Fragment {
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        binding.groceryLayoutListing.setBackgroundColor(getResources().getColor(R.color.white,activity.getTheme()));
        binding.searchLayout.setBackgroundColor(getResources().getColor(R.color.white,activity.getTheme()));
        binding.LinearLayoutTop.setBackgroundColor(getResources().getColor(R.color.white,activity.getTheme()));
//        mGCMPBinding.topLinearLayout.setBackgroundColor(getResources().getColor(R.color.white,activity.getTheme()));
//        mGCMPBinding.tvGcMpAppBarTitle.setTextColor(getResources().getColor(R.color.ar_filter_title_text_color,activity.getTheme()));
...
////        layout_home_restaurant_body.setBackgroundColor(getResources().getColor(R.color.white,activity.getTheme()));
        ...
        // Access the shape resource file
        Drawable shapeDrawable = ContextCompat.getDrawable(getContext(), R.drawable.bg_ar_cuisines_search);
        shapeDrawable.setColorFilter(ContextCompat.getColor(getContext(), R.color.white), PorterDuff.Mode.SRC_ATOP);
        ((GradientDrawable)shapeDrawable).setStroke(getResources().getDimensionPixelSize(com.intuit.sdp.R.dimen._1sdp), ContextCompat.getColor(getContext(), R.color.black));
        binding.laySearchTextSearchItems.setBackground(shapeDrawable);
...
//                    AppFunctions.toastShort(getActivity(), mProductList.get(position).getItemName());
    ...
    public static class CategoriesListBottom extends BottomSheetDialogFragment {
        ...
        public void onConfigurationChanged(Configuration newConfig) {
            ...
            // Set the background color of the CoordinatorLayout to white
        binding_.CategoriesBottomSheetLinearlayout.setBackgroundColor(getResources().getColor(R.color.white,getActivity().getTheme()));
        binding_.tvGCmpBResName.setTextColor(getResources().getColor(R.color.black,getActivity().getTheme()));

        Drawable iconDrawable = ContextCompat.getDrawable(getContext(), R.drawable.baseline_close_black_24dp);
        iconDrawable.setColorFilter(ContextCompat.getColor(getContext(), R.color.black), PorterDuff.Mode.SRC_IN);
        binding_.imgGCmpBCloseBtn.setImageDrawable(iconDrawable);
