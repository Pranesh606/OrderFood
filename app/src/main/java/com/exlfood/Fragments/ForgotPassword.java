...
import com.exlfood.databinding.ForgotPasswordBinding;
...
public class ForgotPassword extends Fragment implements View.OnClickListener, CountryCodeSelection,
    ...
    public void onConfigurationChanged(Configuration newConfig){
        ...
        mForgotPwdBinding.forgotPwdLayout.setBackgroundColor(getResources().getColor(R.color.white,getActivity().getTheme()));
        mForgotPwdBinding.topLinearLayoutForgotPwd.setBackgroundColor(getResources().getColor(R.color.white,getActivity().getTheme()));
        mForgotPwdBinding.topFrameLayoutForgotPwd.setBackgroundColor(getResources().getColor(R.color.white,getActivity().getTheme()));
        mForgotPwdBinding.forgotPwdContainer.setBackgroundColor(getResources().getColor(R.color.white,getActivity().getTheme()));
        mForgotPwdBinding.topLinearLayoutForgotPwd.setBackgroundColor(getResources().getColor(R.color.white,getActivity().getTheme()));


        mForgotPwdBinding.title.setTextColor(getResources().getColor(R.color.ar_filter_title_text_color,getActivity().getTheme()));
        mForgotPwdBinding.etFpMobile.setTextColor(getResources().getColor(R.color.ar_filter_title_text_color,getActivity().getTheme()));
        mForgotPwdBinding.tvFpCountryCode.setTextColor(getResources().getColor(R.color.ar_filter_title_text_color,getActivity().getTheme()));

        mForgotPwdBinding.topLinearLayoutForgotPwd.setBackgroundColor(getResources().getColor(R.color.white,getActivity().getTheme()));

        mForgotPwdBinding.forgotPwdTextInput.setHintTextColor(ColorStateList.valueOf(getResources().getColor(R.color.app_login_hintTextColor_color)));
        mForgotPwdBinding.forgotPwdTextInput.setDefaultHintTextColor(ColorStateList.valueOf(getResources().getColor(R.color.app_login_hintTextColor_color)));
        mForgotPwdBinding.etFpMobile.setTextColor(getResources().getColor(R.color.black));
        mForgotPwdBinding.etFpMobile.setHintTextColor(getResources().getColor(R.color.black));
        ...
        mForgotPwdBinding.imgFpBack.setImageDrawable(iconDrawable);
        ...
        mForgotPwdBinding.imgFpCountryCodeArrow.setImageDrawable(iconDrawable1);
