...
import com.exlfood.Adapters.BannerAdapter;
...
import com.exlfood.CustomClasses.HomeBannerScroller;
import com.exlfood.CustomClasses.NetworkAnalyser;
import com.exlfood.DataSets.AddressListApi;
import com.exlfood.DataSets.AddressListDataSet;
import com.exlfood.DataSets.AreaGeoCodeDataSet;
import com.exlfood.DataSets.BannersDataSet;
import com.exlfood.DataSets.BestOffersDataSet;
import com.exlfood.DataSets.BrandsDataSet;
import com.exlfood.DataSets.BusinessTypesDataSet;
import com.exlfood.DataSets.DrinksDataSet;
import com.exlfood.DataSets.HomeModulesApi;
import com.exlfood.DataSets.ListDataSet;
import com.exlfood.DataSets.TopPickDataSet;
import com.exlfood.Databases.ARCuisinesDB;
import com.exlfood.Databases.ARFiltersDB;
...
import com.exlfood.databinding.HomeDeliveryLocAndAddsBottomSheetBinding;
...
public class ListHome extends Fragment implements View.OnClickListener, onSetUpdate {
    ...
    private TextView mLoggedUserName, txt_pickup, txt_delivery;
    LinearLayout mLayProfileDetails, mLayMyAddresses, mLayMyOrders, mLayChangePwd, delivery_tv, pickup_tv, mSearchContentLay,
            mLayContactUs, mLayAboutUs, mLayPrivacyPolicy, mLayTermsAndConditions, mLayChangeLanguage, mLayDeleteAccount,
            my_favouritesLayout,order_type_linear,layout_home_restaurant_body;
    ...
    CollapsingToolbarLayout collapsing_toolbar_restaurant_store_list;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mSearchContentLay = mRestaurantListView.findViewById(R.id.layout_search);
        txt_pickup = mRestaurantListView.findViewById(R.id.txt_pickup);
        txt_delivery = mRestaurantListView.findViewById(R.id.txt_delivery);
        ...
        pickup_tv = mRestaurantListView.findViewById(R.id.pickup_tv);
        delivery_tv = mRestaurantListView.findViewById(R.id.delivery_tv);
        ...
        coordinatorLayout = mRestaurantListView.findViewById(R.id.lay_restaurant_list);
        order_type_linear = mRestaurantListView.findViewById(R.id.order_type_linear);
        collapsing_toolbar_restaurant_store_list = mRestaurantListView.findViewById(R.id.collapsing_toolbar_restaurant_store_list);
        layout_home_restaurant_body=mRestaurantListView.findViewById(R.id.layout_home_restaurant_body);


        delivery_tv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                delivery_tv.setBackground(activity.getResources().getDrawable(R.drawable.bg_orange_color_curve));
                pickup_tv.setBackground(null);

                txt_delivery.setTextColor(activity.getResources().getColor(R.color.Delivery_Btn));
                txt_pickup.setTextColor(activity.getResources().getColor(R.color.black));
        ...
        pickup_tv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                pickup_tv.setBackground(activity.getResources().getDrawable(R.drawable.bg_orange_color_curve));
                delivery_tv.setBackground(null);

                txt_pickup.setTextColor(activity.getResources().getColor(R.color.Delivery_Btn));
                txt_delivery.setTextColor(activity.getResources().getColor(R.color.black));
        ...
        mSearchContentLay.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        coordinatorLayout.setBackgroundColor(getResources().getColor(R.color.white,activity.getTheme()));
        order_type_linear.setBackgroundColor(getResources().getColor(R.color.white,activity.getTheme()));
        collapsing_toolbar_restaurant_store_list.setBackgroundColor(getResources().getColor(R.color.white,activity.getTheme()));
        layout_home_restaurant_body.setBackgroundColor(getResources().getColor(R.color.white,activity.getTheme()));
...
//
//        mHomeParentListAdapter = new HomeParentListAdapter(getParentFragmentManager(), getActivity(), getActivity().getSupportFragmentManager(), mHomeModulesApi);
//        mRecyclerHomeParent.setAdapter(mHomeParentListAdapter);

        navigationBack.navigationBack(1);
        navigationView.navigationView(true);

        if (OrderTypeDB.getInstance(activity).getUserServiceType() != null && OrderTypeDB.getInstance(activity).getSizeOfList() > 0) {
            if (OrderTypeDB.getInstance(activity).getUserServiceType().equals("2")) {
                pickup_tv.setBackground(activity.getResources().getDrawable(R.drawable.bg_orange_color_curve));
                delivery_tv.setBackground(null);
                txt_pickup.setTextColor(activity.getResources().getColor(R.color.white));
                txt_delivery.setTextColor(activity.getResources().getColor(R.color.black));
            } else {
                delivery_tv.setBackground(activity.getResources().getDrawable(R.drawable.bg_orange_color_curve));
                pickup_tv.setBackground(null);
                txt_pickup.setTextColor(activity.getResources().getColor(R.color.black));
                txt_delivery.setTextColor(activity.getResources().getColor(R.color.white));
            }
        }
...
//                    if (mTime_split.length > 0) {
//                        if (Integer.parseInt(mTime_split[0]) <= 11) {
//                            mListHolder.mSessionPostFixWord.setText(mActivity.getResources().getString(R.string.good_morning));
//                        } else if (Integer.parseInt(mTime_split[0]) <= 16) {
...
//                }
                ...
                if (mHomeModulesApi.businessTypesList != null && mHomeModulesApi.businessTypesList.size() > 0) {
                    ArrayList<BusinessTypesDataSet> businessTypesList = new ArrayList<>();
                    if (mHomeModulesApi.businessTypesList.size() > 7) {
                        for (int i = 0; i < 8; i++) {
                            BusinessTypesDataSet businessTypes = mHomeModulesApi.businessTypesList.get(i);
                            businessTypesList.add(businessTypes);
                        }
                        mListHolder.mRecyclerBusinessTypeList.setVisibility(View.VISIBLE);
                        mListHolder.mHomeBusinessTypeListAdapter = new BusinessTypeListAdapter(businessTypesList);
...
//                AppFunctions.bannerLoaderUsingGlide("", mListHolder.order_type_pickup, mActivity);
                ...
                if (mHomeModulesApi.topPicksList != null && mHomeModulesApi.topPicksList.size() > 0) {
                    ...
                    mListHolder.mTop_picks.setVisibility(View.GONE);
                ...
                if (mHomeModulesApi.brandsList != null && mHomeModulesApi.brandsList.size() > 0) {
                    ...
                    mListHolder.mNotoriousBrandTv.setText(mActivity.getResources().getString(R.string.notorious_brands));
                ...
                if (mHomeModulesApi.drinksList != null && mHomeModulesApi.drinksList.size() > 0) {
                    ...
                    mListHolder.mLikeToDrinkTv.setText(mActivity.getResources().getString(R.string.what_would_you_like_to_drink));
...
//                        callHomeModulesList();
        ...
        public class ListViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, AdapterView.OnItemClickListener {
            ...
            TextView mSessionPostFixWord, mBestOffersTv, mLikeToDrinkTv, mNotoriousBrandTv, delivery_content, pickup_content, mTop_picks;
            ...
            ListViewHolder(View itemView) {
                ...
                mTop_picks = itemView.findViewById(R.id.tv_top_picks_list_title);
                ...
                mBusinessTypeListLayoutMgr = new GridLayoutManager(mActivity, 4);
        ...
        private class BestOfferListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
            ...
            public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
                ...
                if (mBestOffersList.get(position).getRatingDataSet() != null) {
                    String mCRating = " " + mBestOffersList.get(position).getRatingDataSet().getRating() + " ";
                    if (mBestOffersList.get(position).getRatingDataSet().getRating() != null && !mBestOffersList.get(position).getRatingDataSet().getRating().isEmpty()) {
        ...
        private class LikeToDrinkListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
            ...
            public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
                ...
                if (mDrinksList.get(position).getRating() != null) {
                    String mCRating = " " + mDrinksList.get(position).getRating().getRating() + " ";
                    if (mDrinksList.get(position).getRating().getRating() != null && !mDrinksList.get(position).getRating().getRating().isEmpty()) {
                        restaurantViewHolder.tv_rating_statement.setText(mCRating);
                        restaurantViewHolder.tv_rating_statement.setVisibility(View.VISIBLE);
                    } else {
                        restaurantViewHolder.tv_rating_statement.setText("0");
        ...
        private class BusinessTypeListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
            ...
            public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
                ...
                if (i == 7) {
                    restaurantViewHolder.mCategoryImgMoreThan7.setVisibility(View.VISIBLE);
                    restaurantViewHolder.mCategoryImgMoreThan7.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            FragmentTransaction mFT = mFragmentManager.beginTransaction();
                            BusinessTypeListFragment businessTypeListFragment = new BusinessTypeListFragment(mHomeModulesApi.businessTypesList);
                            businessTypeListFragment.show(mFragmentManager, "businessTypeListFragment");
                            mFT.addToBackStack("businessTypeListFragment");
//                            bundle.putSerializable("businessTypeList",mHomeModulesApi.businessTypesList);
//                            mFT.replace(R.id.layout_app_home_body, businessTypeListFragment, "businessTypeListFragment");
//                            mFT.addToBackStack("businessTypeListFragment");
//                            mFT.commit();
                        }
                    });
                } else {
                    restaurantViewHolder.mCategoryImgMoreThan7.setVisibility(View.GONE);
            ...
            class CuisineViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
                ...
                ImageView iv_RestaurantImage, mCategoryImgMoreThan7;
                ...
                CuisineViewHolder(View itemView) {
                    ...
                    mCategoryImgMoreThan7 = itemView.findViewById(R.id.iv_gc_l_category_image_more_than_7);
