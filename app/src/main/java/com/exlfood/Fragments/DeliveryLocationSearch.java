...
import com.exlfood.DataSets.DeliveryLocationSearchDataSet;
import com.exlfood.Databases.AreaGeoCodeDB;
import com.exlfood.Databases.DeliveryLocationSearchDB;
import com.exlfood.Databases.RecentSearchedPlacesDB;
import com.exlfood.Interfaces.CartInfo;
import com.exlfood.R;
import com.exlfood.databinding.DeliveryLocationSearchBinding;
...
//            Places.initialize(getActivity(), /*apiKey*/getResources().getString(R.string.google_server_api_key));
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        mDLSearchBinding.layoutDeliveryLocation.setBackgroundColor(getResources().getColor(R.color.white,getActivity().getTheme()));
        mDLSearchBinding.LinearLayoutTittle.setBackgroundColor(getResources().getColor(R.color.white,getActivity().getTheme()));
        mDLSearchBinding.titleLayout.setBackgroundColor(getResources().getColor(R.color.white,getActivity().getTheme()));
        mDLSearchBinding.layDlsSearchAddsContainer.setBackgroundColor(getResources().getColor(R.color.white,getActivity().getTheme()));
        mDLSearchBinding.tvDlsRecentlySearchedPlacesTitle.setTextColor(getResources().getColor(R.color.ar_filter_title_text_color,getActivity().getTheme()));
